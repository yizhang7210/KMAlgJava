...
public class KMLearner {
     ...
     * @param sampleLoc
     */
    public KMLearner(String sysName, String sampleLoc){
        this.sysName = sysName;
        this.sampleLoc = sampleLoc;
        this.numObs = KMLearner.getSampleDim(sampleLoc)[0];
        this.numFeatures = KMLearner.getSampleDim(sampleLoc)[1] - 1;
    ...
    /**
     * Print the information about this KMLearner.
     */
    public void print(){
